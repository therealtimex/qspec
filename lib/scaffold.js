...
{invocation} render --out documents/                   # committee sheets and Index, internal dossiers, frozen requests
...
- A Selection Sheet is for a committee. A dossier is for the people inside the
  process and belongs under Paperforge's \`[internal]\`, never as a document type.
  Run \`qspec render --out documents/\`, then \`paperforge all --draft --config
  documents/documents.toml\` to build and verify the unpublished committee files.
